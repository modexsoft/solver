...
/* Game specific variables */
	...
	gamedata->spriteSurface[title_sprite] = IMG_Load("data/title.png");
	gamedata->spriteSurface[start_sprite] = IMG_Load("data/start.png");
	gamedata->spriteSurface[options_sprite] = IMG_Load("data/options.png");
	gamedata->spriteSurface[controls_sprite] = IMG_Load("data/controls.png");
	gamedata->spriteSurface[lcursor_sprite] = IMG_Load("data/large_cursor.png");
	gamedata->spriteSurface[scursor_sprite] = IMG_Load("data/small_cursor.png");
	gamedata->spriteSurface[s0_sprite] = IMG_Load("data/s0.png");
	gamedata->spriteSurface[s1_sprite] = IMG_Load("data/s1.png");
	gamedata->spriteSurface[s2_sprite] = IMG_Load("data/s2.png");
	gamedata->spriteSurface[s3_sprite] = IMG_Load("data/s3.png");
	gamedata->spriteSurface[s4_sprite] = IMG_Load("data/s4.png");
	gamedata->spriteSurface[s5_sprite] = IMG_Load("data/s5.png");
	gamedata->spriteSurface[s6_sprite] = IMG_Load("data/s6.png");
	gamedata->spriteSurface[s7_sprite] = IMG_Load("data/s7.png");
	gamedata->spriteSurface[s8_sprite] = IMG_Load("data/s8.png");
	gamedata->spriteSurface[s9_sprite] = IMG_Load("data/s9.png");
	gamedata->spriteSurface[sblank_sprite] = IMG_Load("data/sblank.png");
	gamedata->spriteSurface[scolon_sprite] = IMG_Load("data/scolon.png");

	gamedata->spriteSurface[key0_sprite] = IMG_Load("data/key_0.png");
	gamedata->spriteSurface[key1_sprite] = IMG_Load("data/key_1.png");
	gamedata->spriteSurface[key2_sprite] = IMG_Load("data/key_2.png");
	gamedata->spriteSurface[key3_sprite] = IMG_Load("data/key_3.png");
	gamedata->spriteSurface[key4_sprite] = IMG_Load("data/key_4.png");
	gamedata->spriteSurface[key5_sprite] = IMG_Load("data/key_5.png");
	gamedata->spriteSurface[key6_sprite] = IMG_Load("data/key_6.png");
	gamedata->spriteSurface[key7_sprite] = IMG_Load("data/key_7.png");
	gamedata->spriteSurface[key8_sprite] = IMG_Load("data/key_8.png");
	gamedata->spriteSurface[key9_sprite] = IMG_Load("data/key_9.png");
	gamedata->spriteSurface[keya_sprite] = IMG_Load("data/key_a.png");
	gamedata->spriteSurface[keyb_sprite] = IMG_Load("data/key_b.png");
	gamedata->spriteSurface[keyc_sprite] = IMG_Load("data/key_c.png");
	gamedata->spriteSurface[keyd_sprite] = IMG_Load("data/key_d.png");
	gamedata->spriteSurface[keye_sprite] = IMG_Load("data/key_e.png");
	gamedata->spriteSurface[keyf_sprite] = IMG_Load("data/key_f.png");
	gamedata->spriteSurface[keyg_sprite] = IMG_Load("data/key_g.png");
	gamedata->spriteSurface[keyh_sprite] = IMG_Load("data/key_h.png");
	gamedata->spriteSurface[keyi_sprite] = IMG_Load("data/key_i.png");
	gamedata->spriteSurface[keyj_sprite] = IMG_Load("data/key_j.png");
	gamedata->spriteSurface[keyk_sprite] = IMG_Load("data/key_k.png");
	gamedata->spriteSurface[keyl_sprite] = IMG_Load("data/key_l.png");
	gamedata->spriteSurface[keym_sprite] = IMG_Load("data/key_m.png");
	gamedata->spriteSurface[keyn_sprite] = IMG_Load("data/key_n.png");
	gamedata->spriteSurface[keyo_sprite] = IMG_Load("data/key_o.png");
	gamedata->spriteSurface[keyp_sprite] = IMG_Load("data/key_p.png");
	gamedata->spriteSurface[keyq_sprite] = IMG_Load("data/key_q.png");
	gamedata->spriteSurface[keyr_sprite] = IMG_Load("data/key_r.png");
	gamedata->spriteSurface[keys_sprite] = IMG_Load("data/key_s.png");
	gamedata->spriteSurface[keyt_sprite] = IMG_Load("data/key_t.png");
	gamedata->spriteSurface[keyu_sprite] = IMG_Load("data/key_u.png");
	gamedata->spriteSurface[keyv_sprite] = IMG_Load("data/key_v.png");
	gamedata->spriteSurface[keyw_sprite] = IMG_Load("data/key_w.png");
	gamedata->spriteSurface[keyx_sprite] = IMG_Load("data/key_x.png");
	gamedata->spriteSurface[keyy_sprite] = IMG_Load("data/key_y.png");
	gamedata->spriteSurface[keyz_sprite] = IMG_Load("data/key_z.png");
	gamedata->spriteSurface[keypointer_sprite] = IMG_Load("data/key_pointer.png");
	gamedata->spriteSurface[keyblank_sprite] = IMG_Load("data/key_blank.png");

	gamedata->spriteSurface[labelscore_sprite] = IMG_Load("data/label_score.png");
	gamedata->spriteSurface[labelspeed_sprite] = IMG_Load("data/label_speed.png");
	gamedata->spriteSurface[labeltime_sprite] = IMG_Load("data/label_time.png");
	gamedata->spriteSurface[labelhit_sprite] = IMG_Load("data/label_hit.png");
	gamedata->spriteSurface[labelmiss_sprite] = IMG_Load("data/label_miss.png");
	gamedata->spriteSurface[labeltotal_sprite] = IMG_Load("data/label_total.png");

	gamedata->spriteSurface[blockdivide0_sprite] = IMG_Load("data/block_divide0.png");
	gamedata->spriteSurface[blockdivide1_sprite] = IMG_Load("data/block_divide1.png");
	gamedata->spriteSurface[blockdivide2_sprite] = IMG_Load("data/block_divide2.png");
	gamedata->spriteSurface[blockdivide3_sprite] = IMG_Load("data/block_divide3.png");
	gamedata->spriteSurface[blockdivide4_sprite] = IMG_Load("data/block_divide4.png");
	gamedata->spriteSurface[blockdivide5_sprite] = IMG_Load("data/block_divide5.png");
	gamedata->spriteSurface[blockdivide6_sprite] = IMG_Load("data/block_divide6.png");
	gamedata->spriteSurface[blockdivide7_sprite] = IMG_Load("data/block_divide7.png");
	gamedata->spriteSurface[blockdivide8_sprite] = IMG_Load("data/block_divide8.png");
	gamedata->spriteSurface[blockdivide9_sprite] = IMG_Load("data/block_divide9.png");

	gamedata->spriteSurface[blockminus0_sprite] = IMG_Load("data/block_minus0.png");
	gamedata->spriteSurface[blockminus1_sprite] = IMG_Load("data/block_minus1.png");
	gamedata->spriteSurface[blockminus2_sprite] = IMG_Load("data/block_minus2.png");
	gamedata->spriteSurface[blockminus3_sprite] = IMG_Load("data/block_minus3.png");
	gamedata->spriteSurface[blockminus4_sprite] = IMG_Load("data/block_minus4.png");
	gamedata->spriteSurface[blockminus5_sprite] = IMG_Load("data/block_minus5.png");
	gamedata->spriteSurface[blockminus6_sprite] = IMG_Load("data/block_minus6.png");
	gamedata->spriteSurface[blockminus7_sprite] = IMG_Load("data/block_minus7.png");
	gamedata->spriteSurface[blockminus8_sprite] = IMG_Load("data/block_minus8.png");
	gamedata->spriteSurface[blockminus9_sprite] = IMG_Load("data/block_minus9.png");

	gamedata->spriteSurface[blockmultiply0_sprite] = IMG_Load("data/block_multiply0.png");
	gamedata->spriteSurface[blockmultiply1_sprite] = IMG_Load("data/block_multiply1.png");
	gamedata->spriteSurface[blockmultiply2_sprite] = IMG_Load("data/block_multiply2.png");
	gamedata->spriteSurface[blockmultiply3_sprite] = IMG_Load("data/block_multiply3.png");
	gamedata->spriteSurface[blockmultiply4_sprite] = IMG_Load("data/block_multiply4.png");
	gamedata->spriteSurface[blockmultiply5_sprite] = IMG_Load("data/block_multiply5.png");
	gamedata->spriteSurface[blockmultiply6_sprite] = IMG_Load("data/block_multiply6.png");
	gamedata->spriteSurface[blockmultiply7_sprite] = IMG_Load("data/block_multiply7.png");
	gamedata->spriteSurface[blockmultiply8_sprite] = IMG_Load("data/block_multiply8.png");
	gamedata->spriteSurface[blockmultiply9_sprite] = IMG_Load("data/block_multiply9.png");

	gamedata->spriteSurface[blockplus0_sprite] = IMG_Load("data/block_plus0.png");
	gamedata->spriteSurface[blockplus1_sprite] = IMG_Load("data/block_plus1.png");
	gamedata->spriteSurface[blockplus2_sprite] = IMG_Load("data/block_plus2.png");
	gamedata->spriteSurface[blockplus3_sprite] = IMG_Load("data/block_plus3.png");
	gamedata->spriteSurface[blockplus4_sprite] = IMG_Load("data/block_plus4.png");
	gamedata->spriteSurface[blockplus5_sprite] = IMG_Load("data/block_plus5.png");
	gamedata->spriteSurface[blockplus6_sprite] = IMG_Load("data/block_plus6.png");
	gamedata->spriteSurface[blockplus7_sprite] = IMG_Load("data/block_plus7.png");
	gamedata->spriteSurface[blockplus8_sprite] = IMG_Load("data/block_plus8.png");
	gamedata->spriteSurface[blockplus9_sprite] = IMG_Load("data/block_plus9.png");

	gamedata->spriteSurface[blockselect_sprite] = IMG_Load("data/block_select.png");
	gamedata->spriteSurface[blockblank_sprite] = IMG_Load("data/block_blank.png");
	gamedata->spriteSurface[blockmeter_sprite] = IMG_Load("data/block_meter.png");
	gamedata->spriteSurface[blockmeterblank_sprite] = IMG_Load("data/block_meterblank.png");
	gamedata->spriteSurface[blockmetertopbottom_sprite] = IMG_Load("data/block_topbottom.png");

	gamedata->spriteSurface[eq0_sprite] = IMG_Load("data/eq_0.png");
	gamedata->spriteSurface[eq1_sprite] = IMG_Load("data/eq_1.png");
	gamedata->spriteSurface[eq2_sprite] = IMG_Load("data/eq_2.png");
	gamedata->spriteSurface[eq3_sprite] = IMG_Load("data/eq_3.png");
	gamedata->spriteSurface[eq4_sprite] = IMG_Load("data/eq_4.png");
	gamedata->spriteSurface[eq5_sprite] = IMG_Load("data/eq_5.png");
	gamedata->spriteSurface[eq6_sprite] = IMG_Load("data/eq_6.png");
	gamedata->spriteSurface[eq7_sprite] = IMG_Load("data/eq_7.png");
	gamedata->spriteSurface[eq8_sprite] = IMG_Load("data/eq_8.png");
	gamedata->spriteSurface[eq9_sprite] = IMG_Load("data/eq_9.png");

	gamedata->spriteSurface[eqequal_sprite] = IMG_Load("data/eq_equal.png");
	gamedata->spriteSurface[eqplus_sprite] = IMG_Load("data/eq_plus.png");
	gamedata->spriteSurface[eqminus_sprite] = IMG_Load("data/eq_minus.png");
	gamedata->spriteSurface[eqdivide_sprite] = IMG_Load("data/eq_divide.png");
	gamedata->spriteSurface[eqmultiply_sprite] = IMG_Load("data/eq_multiply.png");

	gamedata->spriteSurface[bordertopleft_sprite] = IMG_Load("data/bordertopleft.png");
	gamedata->spriteSurface[borderleftright_sprite] = IMG_Load("data/borderleftright.png");
	gamedata->spriteSurface[bordertopright_sprite] = IMG_Load("data/bordertopright.png");
	gamedata->spriteSurface[borderdownleft_sprite] = IMG_Load("data/borderdownleft.png");
	gamedata->spriteSurface[borderupdown_sprite] = IMG_Load("data/borderupdown.png");
	gamedata->spriteSurface[borderdownright_sprite] = IMG_Load("data/borderdownright.png");
	gamedata->spriteSurface[gameover_sprite] = IMG_Load("data/gameover.png");

	gamedata->spriteSurface[background0_sprite] = IMG_Load("data/bg0.png");
	gamedata->spriteSurface[background1_sprite] = IMG_Load("data/bg1.png");
	gamedata->spriteSurface[background2_sprite] = IMG_Load("data/bg2.png");
	gamedata->spriteSurface[background3_sprite] = IMG_Load("data/bg3.png");
	gamedata->spriteSurface[background4_sprite] = IMG_Load("data/bg4.png");

	gamedata->spriteSurface[combo0_sprite] = IMG_Load("data/combo0.png");
	gamedata->spriteSurface[combo1_sprite] = IMG_Load("data/combo1.png");
	gamedata->spriteSurface[combo2_sprite] = IMG_Load("data/combo2.png");
	gamedata->spriteSurface[combo3_sprite] = IMG_Load("data/combo3.png");
	gamedata->spriteSurface[combo4_sprite] = IMG_Load("data/combo4.png");
	gamedata->spriteSurface[combo5_sprite] = IMG_Load("data/combo5.png");
	gamedata->spriteSurface[combo6_sprite] = IMG_Load("data/combo6.png");
	gamedata->spriteSurface[combo7_sprite] = IMG_Load("data/combo7.png");
	gamedata->spriteSurface[combo8_sprite] = IMG_Load("data/combo8.png");
	gamedata->spriteSurface[combo9_sprite] = IMG_Load("data/combo9.png");
	gamedata->spriteSurface[combo10_sprite] = IMG_Load("data/combo10.png");
	...
	gamedata->sfx[ANSWER_CORRECT] = Mix_LoadWAV("data/answer_correct.wav");
	gamedata->sfx[ANSWER_TYPING] = Mix_LoadWAV("data/answer_typing.wav");
	gamedata->sfx[ANSWER_WRONG] = Mix_LoadWAV("data/answer_wrong.wav");
	gamedata->sfx[PIECE_FLIP] = Mix_LoadWAV("data/piece_flip.wav");
	gamedata->sfx[MOVE_CURSOR] = Mix_LoadWAV("data/move_cursor.wav");
	gamedata->sfx[MENU_SELECT] = Mix_LoadWAV("data/menu_select.wav");
